...
public class Prgrm9 
{
    public static void main(String []args)
    {
        ...
        for(i=0;i<4;i++)
        {
            for(j=0;j<2;j++)
        {
        d1=Math.sqrt(Math.pow(dataset[i][j]-m1[0][0],2)+Math.pow(dataset[i][j]-m1[0][1],2));
         d2=Math.sqrt(Math.pow(dataset[i][j]-m2[0][0],2)+Math.pow(dataset[i][j]-m2[0][1],2));
        }
